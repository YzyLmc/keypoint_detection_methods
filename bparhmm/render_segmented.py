"""
Render dataset demonstrations as videos with BP-AR-HMM skill labels overlaid.
...
Usage:
    python bparhmm/render_segmented.py \
        ...
        --segmentation bparhmm/results_robomimic/segmentation.pkl \
        --render_image_names agentview \
        --output_dir bparhmm/results_robomimic/videos
"""
